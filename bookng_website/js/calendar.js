  ...
  Calendar.prototype = {
    ...
    showCalendar: function () { // 输入数据并显示
      ...
      this.$calendarDate_item.each(function (i) {
        ...
        $(this).text(allDay.getDate()).attr('data-id', allDay_str);
    ...
    renderDOM: function () { // 渲染DOM
      ...
      for (var i = 0; i < 6; i++) {
        _dateStr += '<li class="item" onclick="displayReservation(this);">26</li>'+
                    '<li class="item" onclick="displayReservation(this);">26</li>'+
                    '<li class="item" onclick="displayReservation(this);">26</li>'+
                    '<li class="item" onclick="displayReservation(this);">26</li>'+
                    '<li class="item" onclick="displayReservation(this);">26</li>'+
                    '<li class="item" onclick="displayReservation(this);">26</li>'+
