<?php
    ...
    if(count($_POST) > 0) { 
        $rId = $_POST['rId'];
        $sql = "UPDATE `restaurant` SET rName = '" . $_POST['rName'] . "', rPhone = '" . $_POST['rPhone'] . "', rAddress = '" . $_POST['rAddress'] . "', rDesc = '" . $_POST['rDesc'] . "', bottomPrice = '" . $_POST['bottomPrice'] . "' WHERE rId = '" . $_POST['rId'] . "'";
        ...
        if (is_uploaded_file($_FILES['photo']['tmp_name'])) {
            ...
            $sql = "INSERT INTO `restaurant` (`rId`, `rName`, `rPhone`, `rAddress`, `rate`, `rDesc`, `bottomPrice`, `photo`, `map`, `reservation_creditScore`, `cancelDay`) VALUES ('" . $row['rId'] . "', '" . $row['rName'] . "', '" . $row['rPhone'] . "', '" . $row['rAddress'] . "', '" . $row['rate'] . "', '" . $row['rDesc'] . "', '" . $row['bottomPrice'] . "', '$imgData', '" . $row['map'] . "', '" . $row['reservation_creditScore'] . "', '" . $row['cancelDay'] . "')";
